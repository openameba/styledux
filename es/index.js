...
function createStyleduxStore() {
  ...
  if (middlewares && middlewares.length > 0) {
    return createStore(rootReducer, applyMiddleware.apply(void 0, middlewares));
  }
...
export { withStyle, StyleduxProvider, createStyleduxStore, mapStateOnServer, handleStateChangeOnClient };
